...
# Finer grid cell size (to create a more detailed grid)
fine_cell_size = 600  # mm (You can adjust this to make it even finer)

# Sprinkler constraints
sprinkler_radius = 1500  # mm (for drawing the blue circle only)
min_sprinkler_distance = 1200  # mm (for calculating valid positions)
max_sprinkler_distance = 1500  # mm (for calculating valid positions)
...
room_dimensions = [(0, 0), (4800, 0), (4800, 5200), (0, 5200), (0, 4000), (3080, 4000), (3080, 2800), (-1800, 2800),(-1800,6800),(0,6800),(0,4000)]
...
# Overlay finer grid
for x in np.arange(0, width + fine_cell_size, fine_cell_size):
    ax.axvline(x=x, color='gray', linestyle='--', linewidth=0.5)
for y in np.arange(0, height + fine_cell_size, fine_cell_size):
...
# Label the plot
ax.set_title('Hall Layout with Finer Grid, Lights, and Sprinklers')
