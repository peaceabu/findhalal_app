...
for x in np.arange(0, width1 + cell_size, cell_size):
    ax.axvline(x=x, color='black', linestyle='-', linewidth=1)
for y in np.arange(0, height1 + cell_size, cell_size):
...
# Overlay finer grid
for x in np.arange(0, width1 + fine_cell_size, fine_cell_size):
    ax.axvline(x=x, color='gray', linestyle='--', linewidth=0.5)
for y in np.arange(0, height1 + fine_cell_size, fine_cell_size):
    ax.axhline(y=y, color='gray', linestyle='--', linewidth=0.5)

for x in np.arange(4800, 4800 + width2 + fine_cell_size, fine_cell_size):
    ax.axvline(x=x, color='gray', linestyle='--', linewidth=0.5)
